...
def recibeInsertRegisterUser(cedula, name, surname, id_area, id_rol, pass_user,id_dispositivo,):
        ...
        try:
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as mycursor:
                    sql = """
                    INSERT INTO usuarios(cedula, nombre_usuario, apellido_usuario, id_area, id_rol,  password,id_dispositivo,) 
                    VALUES (%s, %s, %s, %s, %s, %s, %s)
                    """
                    valores = (cedula, name, surname, id_area, id_rol, nueva_password,id_dispositivo)
...
def info_perfil_session(id):
    ...
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = "SELECT id_usuario, nombre_usuario, apellido_usuario, cedula, id_area, id_rol, id_dispositivo FROM usuarios WHERE id_usuario = %s"
...
def procesar_update_perfil(data_form,id):
    ...
    id_dispositivo= data_form['selectDispositivo']
            ...
            with connectionBD() as conexion_MySQLdb:
                with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                    querySQL = """
                        ...
                        WHERE id_usuario = %s
                    """
                    params = (nombre_usuario,apellido_usuario, id_area, id_rol, id_dispositivo,
    ...
    if not pass_actual and not new_pass_user and not repetir_pass_user:
            return updatePefilSinPass(id_user, nombre_usuario, apellido_usuario, id_area, id_rol, id_dispositivo)
...
def updatePefilSinPass(id_user, nombre_usuario, apellido_usuario, id_area, id_rol, id_dispositivo):
    try:
        with connectionBD() as conexion_MySQLdb:
            with conexion_MySQLdb.cursor(dictionary=True) as cursor:
                querySQL = """
                    ...
                    WHERE id_usuario = %s
                """
                params = ( nombre_usuario, apellido_usuario, id_area, id_rol, id_dispositivo, id_user)
                cursor.execute(querySQL, params)
                conexion_MySQLdb.commit()
